    ...
    function waitForSearch() {
        ...
        if (input && resultsContainer) {
            ...
            document.addEventListener('click', function (e) {
                let target = e.target;
                // 查找带有 'docsify-tag-link' 类的父元素
                while (target && !target.classList.contains('docsify-tag-link')) {
                    target = target.parentElement;
                }
                
                if (target && target.classList.contains('docsify-tag-link')) {
